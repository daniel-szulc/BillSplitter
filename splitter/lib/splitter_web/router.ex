defmodule SplitterWeb.Router do
  use SplitterWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {SplitterWeb.LayoutView, :root}
  ...
  scope "/", SplitterWeb do
    ...
    get "/split", BillsController, :splitBills
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: SplitterWeb.Telemetry
    end
  end
